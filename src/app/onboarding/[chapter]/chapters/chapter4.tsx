...
const SCENARIOS = [
	{
		...
		options: [
			...
			{ value: "farmers_market", label: "Hit Viktualienmarkt early before the crowds" },
			{ value: "workout", label: "Morning workout, then reward yourself with coffee" },
			{ value: "wander", label: "Just walk out and see what happens" },
		],
	},
	{
		id: "friend_visiting",
		question: "A friend is visiting Munich for the first time. You take them to...",
		options: [
			{ value: "hidden_gem", label: "Your favorite hidden spot no tourist would find" },
			{ value: "classic_twist", label: "A classic Munich experience with your own twist" },
			{ value: "food_tour", label: "An eating and drinking tour through your favorite neighborhood" },
			{ value: "nature", label: "The Isar or English Garden — the city's best side is outdoors" },
		],
	},
	{
		id: "solo_evening",
		...
		options: [
			{ value: "cozy_bar", label: "Find a cozy bar with a book or good people-watching" },
			{ value: "new_restaurant", label: "Try that new restaurant you've been eyeing" },
	...
	},
	{
		...
		options: [
			{ value: "vibe", label: "The vibe — lighting, music, how the space feels" },
			{ value: "crowd", label: "The crowd — interesting people, the right energy" },
			{ value: "menu", label: "The menu — something unique or done really well" },
			{ value: "location", label: "The location — terrace, river view, perfect corner" },
		],
	},
	{
		id: "weekend_plan",
		...
		options: [
			{ value: "packed", label: "A packed schedule — brunch, activity, dinner, drinks" },
			{ value: "one_thing", label: "One really good thing and lots of free time" },
